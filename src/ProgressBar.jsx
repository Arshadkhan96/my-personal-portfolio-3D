...
const ProgressBar = () => {
    ...
    useEffect(()=>{
        ...
        //Create GSAP animation that update the width of the progress bar
            ...
            scrollTrigger:{
                ...
                onUpdate:(self)=>{
                    ...
                    if( progress > 0.75){
                        ...
                        gsap.to(progresFillRef.current,{backgroundColor:"#C54BBC",duration:0.5})
                    }
                }
            }
        })
  ...
  return (
    ...
    className='fixed top-0 left-0 w-full h-[5px] bg-gray-800 z-50'>
        <div
        ref={progressFillRef}
        className="h-full w-0 bg-[#A1045a] transition-colors duration-300" style={{width:"0%"}}></div>
