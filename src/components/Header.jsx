      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20">
        ...
        <div className="md:flex hidden items-center space-x-4">
          <motion.a
            ...
            href="https://github.com/Arshadkhan96"
          ...
          <motion.a
            ...
            href="https://x.com/ArshadKing71266"
            className="text-gray-700 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400 transition-colors duration-300"
          >
          ...
          <motion.a
            ...
            href="https://www.linkedin.com/in/arshad-ali-4412732b9/"
            className="text-gray-700 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400 transition-colors duration-300"
          >
        ...
        >
          ...
          {/* Mobile Menu Button */}
           <div className="md:hidden flex items-center">
            ...
            whileTap={{ scale: 0.7 }}
            onClick={toggleMenu}
            className="text-gray-300 dark:text-gray-200 hover:text-violet-600 dark:hover:text-violet-400 focus:outline-none" >
      ...
      className="md:hidden overflow-hidden bg-white dark:bg-gray-900 shadow-lg px-4 py-5 space-y-5">
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
          <div className="flex space-x-5">
            <a href="https://github.com/Arshadkhan96">
              <FiGithub  className="h-5 w-5 text-gray-300" />
            </a>

            <a href="https://x.com/ArshadKing71266">
          ...
          className="mt-4 block w-full py-2 px-4 rounded-lg bg-gradient-to-r from-violet-600 to-violet-400 font-bold">
            Contact Me
          </button>
        </div>
      </motion.div>
