...
const ProjectSection = () => {
  ...
  const projectImages = [
    { id: 1, title: "3D Gaming Website", imageSrc: "/images/project-1.png" },
    { id: 2, title: "Startup App", imageSrc: "/images/project-2.png" },
    { id: 3, title: "Portfolio Website", imageSrc: "/images/project-3.png" },
    { id: 4, title: "Award Winning Web", imageSrc: "/images/project-4.png" },
  ];
  ...
  useEffect(() => {
    ...
    panels.forEach((panel) => {
      ...
      // Image scale + rotation animation
      tl.fromTo(
        image,
        { scale: 0, rotate: -20 },
